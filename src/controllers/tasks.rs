...
Верни ответ в формате JSON без лишних символов, т.е без `:
{
  ...
  "reply": <ответ на промпт пользователя, ты должен выполнить его задание, он не сильно распространенный, довольно краткий, но не сильно>, // ЭТО ПОЛЕ НЕ МОЖЕТ БЫТЬ ПУСТЫМ
